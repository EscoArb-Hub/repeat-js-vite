...
// const findBriefName = (value) => {
//     const arrResult = aircrafts.filter(element =>
//         element.name.brief
//             .toUpperCase()
...
// з використанням методу debounce
// findName.addEventListener("input", lodash.debounce(findBriefName,500));
findName.addEventListener("input", debounce(findBriefName, 3000));
// findName.addEventListener(
//     "input",
//     debounce((event) => {
//         findBriefName(event.target.value);
//     }, 5000)
// );
